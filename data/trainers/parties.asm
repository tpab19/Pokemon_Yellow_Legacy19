...
; Silph Co. 11F
	db $FF, 44, KINGLER, 44, KANGASKHAN,  45, MACHAMP , 44, GOLEM, 47, PERSIAN, 0
; Viridian Gym
	db $FF, 53, DUGTRIO, 55, PERSIAN,  54, NIDOKING, 55, RHYDON, 55, MEWTWO, 0
...
BrockData:
	db $FF, 10, GEODUDE, 12, GRAVELER, 12, ONIX, 0
; Rematch
	db $FF, 64, OMASTAR, 65, ONIX, 64, KABUTOPS, 64, GOLEM, 64, NINETALES, 65, AERODACTYL, 0

MistyData:
	db $FF, 18, GOLDEEN, 19, STARYU, 18, PSYDUCK, 21, SEADRA, 0
; Rematch
	db $FF, 64, SEADRA, 65, GOLDUCK, 64, LAPRAS, 64, GYARADOS, 64, VAPOREON, 65, STARMIE, 0

LtSurgeData:
	db $FF, 24, VOLTORB, 24, RAICHU, 26, ELECTABUZZ, 0
; Rematch
	db $FF, 64, ELECTRODE, 65, MAGNETON, 64, JOLTEON, 64, PORYGON, 64, ELECTABUZZ, 65, RAICHU, 0

ErikaData:
	db $FF, 33, TANGELA, 34, GLOOM, 34, WEEPINBELL, 35, VILEPLUME, 0
...
KogaData:
	db $FF, 42, SCYTHER, 42, GOLBAT, 42, TENTACRUEL, 42, MUK, 43, VICTREEBEL, 0
	db $FF, 48, SCYTHER, 49, GOLBAT, 48, TENTACRUEL, 48, MUK, 50, VICTREEBEL, 0
; Rematch
	db $FF, 65, SCYTHER, 64, GOLBAT, 64, TENTACRUEL, 65, MUK, 64, VICTREEBEL, 65, WEEZING, 0

BlaineData:
	db $FF, 52, RAPIDASH, 51, CHARIZARD, 51, NINETALES, 52, MAGMAR, 53, ARCANINE, 53, MOLTRES, 0
; Rematch
	db $FF, 64, RAPIDASH, 64, CHARIZARD, 64, NINETALES, 65, MAGMAR, 64, ARCANINE, 65, MOLTRES, 0
...
; Champion's Room
	...
	db $FF, 62, SCYTHER, 61, DODRIO, 63, ALAKAZAM, 60, NIDOKING, 62, GOLDUCK, 65, FLAREON, 0
	db $FF, 60, MACHAMP, 61, PIDGEOT, 62, NINETALES, 62, EXEGGUTOR, 63, ALAKAZAM, 65, VAPOREON, 0
; Rematch
...
AgathaData:
	db $FF, 57, GENGAR, 58, PARASECT, 57, MAROWAK, 58, NINETALES, 59, GENGAR, 0
; Rematch
